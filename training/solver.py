...
from util.utils import MultiDimAverageMeter, ValidLogger, AverageMeter
from util.utils import evaluate_gr
...
class Solver(nn.Module):
    def __init__(self, args):
        ...
        self.valid_logger = ValidLogger(ospj(args.log_dir, f'erm_acc_{args.pruning_iter}.pkl'))
        ...
        self.loaders = Munch(train=get_original_loader(args),
                             val=get_val_loader(args, split = 'test'),
    ...
    def validation(self, fetcher, which='main'):
        ...
        #results = evaluate_gr(local_classifier, fetcher, self.args)
