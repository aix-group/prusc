...
from data.dataset import CelebADataset, IdxDataset, ISICDataset, CUBDataset
...
def get_val_loader(args, split='test'):
    dataset_name = args.data
    transform = transforms['preprocess' if use_preprocess[dataset_name] else 'original'][dataset_name]['valid']
    dataset_class = dataset_name_dict[dataset_name]
